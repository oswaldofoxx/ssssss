    ...
    <nav class="nav-section">
        <div class="container">
            <div class="nav-right">
                ...
                <a href="#" class="btn btn-success"><?php echo __('Register') ?></a>
            ...
            <ul class="main-menu" >
                ...
                <li><a href="about.html"><?php echo __('About Us') ?></a></li>
                <li><a href="servicios.html"><?php echo __('Services') ?></a></li>
                <!--<li><a href="#" class="main-menu">Register</a></li>
